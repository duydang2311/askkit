            ...
            <div {...select.getRootProps()}>
                ...
                <div use:portal {...select.getPositionerProps()}>
                    <ul
                        ...
                        class="bg-base-light dark:bg-base-dark border-base-border max-h-(--available-height) w-(--reference-width) min-w-max overflow-auto border p-1 focus:outline-none"
                    >
